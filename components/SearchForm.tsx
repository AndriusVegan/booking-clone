...
function SearchForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    console.log(values);
    // reconstructed from booking.com search results url
  ...
  return (
    <Form {...form}>
      <form
        ...
        // handlesSubmit allows to check against all the requirements of the form
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-white flex">
                  {/* need to check why background is white and not blue */}
                  Location
              ...
              <FormItem className="flex flex-col">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    {/* popover trigger are dates when click on them */}
                    <FormControl>
                      <Button
                        id="date"
                        name="dates"
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      ...
                      disabled={
                        ...
                        // disabling previous dates so no booking in the past time.
                      }
                    />
                  </PopoverContent>
                </Popover>
